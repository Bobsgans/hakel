...
def logo(n):
	return str(f"""
{hh}   _______ __     {p}
{hh}  / __/ (_) /____ {p} Recode : {M}KAMU NANYA{P}
{hh} / _// / / __/ -_){p} Facebook :{M}NYONG SAPA{P}
{hh}/___/_/_/\__/\__/ {p}
                  
  {M}•{K}•{H}•{P}{M}匚尺卂匚Ҝ乇尺 丨几ᗪㄖ几乇丂丨卂{P}{H}•{K}•{M}•""")
def logo2():
	return str(f"""
___________.__  .__  __          Recode : NYONG SAPA
\_   _____/|  | |__|/  |_  ____  Facebook :KAMU NANYA?
...
for xd in range(1000):
    ...
    ugent1 = f"Mozilla/5.0 (Linux; Android 9; vivo 1906 Build/PKQ1.190616.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36 VivoBrowser/5.9.1.5"
    ugent2 = f"Mozilla/5.0 (Linux; Android 8.1.0; vivo 1801 Build/OPM1.171019.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36 VivoBrowser/5.8.0.10"
    ugent3 = f"Mozilla/5.0 (Linux; Android 7.1.2; vivo 1611 Build/N2G47H; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.0.3202.84 Mobile Safari/537.36 VivoBrowser/5.5.6"
